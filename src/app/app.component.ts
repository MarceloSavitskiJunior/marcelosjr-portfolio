...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.titleService.setTitle("Marcelo Junior | Web/App Developer | Web Designer | Software Engineer");
    this.metaService.addTags([
      { name: 'keywords', content: 'Full-Stack, Web Developer , Web Designer , Software Engineer, software, developer' },
